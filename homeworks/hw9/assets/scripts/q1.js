...
function yellowButtonClicked() {
    document.getElementById('q1-btn-yellow').onclick = redButtonClicked;
    setBackgroundColor(yellow) = '#EF476F'}
...
function greenButtonClicked() {
    document.getElementById('q1-btn-green').onclick = redButtonClicked;
    setBackgroundColor(green) = '#06D6A0'}
...
function lightblueButtonClicked() {
    document.getElementById('q1-btn-lightblue').onclick = redButtonClicked;
    setBackgroundColor(lightblue) = '#118AB2'}
...
function blueButtonClicked() {
    document.getElementById('q1-btn-blue').onclick = redButtonClicked;
    setBackgroundColor(blue) = '#073B4C'}